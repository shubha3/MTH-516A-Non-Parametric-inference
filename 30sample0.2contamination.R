...
for (i in 1:1000)
{
data1=as.data.frame(f1(30,0.2,beta))
...
for (i in 1:1000)
{
data2=as.data.frame(f1(30,0.2,beta))
...
plot(data1$X2,data1$Y,main="Simulated analysis for n=30 and 20% contamination")
abline(a$coef[1],a$coef[2])
abline(lm(Y~X2,data=data1),col="red")
abline(5,5,col="blue")
legend(-2, 30, legend=c("OLS", "MM estimation","True Model"), fill = c("red","black","blue"))