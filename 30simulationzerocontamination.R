...
for (i in 1:1000)
{
data1=as.data.frame(f1(30,0,beta))
...
for (i in 1:1000)
{
data2=as.data.frame(f1(30,0,beta))
...
plot(data1$X2,data1$Y,main="Simulated analysis for sample size 30 with zero contamination")
abline(a$coef[1],a$coef[2])
abline(lm(Y~X2,data=data1),col="red")
abline(5,5,col="blue")
legend(-2, 15, legend=c("OLS", "MM estimation","True Model"), fill = c("red","black","blue"))